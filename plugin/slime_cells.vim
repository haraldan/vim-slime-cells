...
onoremap <silent> ie :<c-u>call slime_cells#select_current_cell(0)<cr>
onoremap <silent> ae :<c-u>call slime_cells#select_current_cell(1)<cr>
vnoremap <silent> ie :<c-u>call slime_cells#select_current_cell(0)<cr>
vnoremap <silent> ae :<c-u>call slime_cells#select_current_cell(1)<cr>
